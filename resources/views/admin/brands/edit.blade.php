    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h3 class="mb-1">Sửa thương hiệu</h3>
                    <p class="text-muted mb-0">Cập nhật thông tin thương hiệu hiện tại.</p>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="brandname" value="{{ old('brandname', $brand->brandname) }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Slug</label>
                            <input class="form-control" name="slug" value="{{ old('slug', $brand->slug) }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Thứ tự</label>
                            <input class="form-control" type="number" min="0" name="sort_order" value="{{ old('sort_order', $brand->sort_order) }}">
                        </div>
                        <div class="mb-3">
