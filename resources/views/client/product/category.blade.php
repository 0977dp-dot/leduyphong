...
<div class="container py-4">
    <h3 class="fw-bold mb-4"><i class="bi bi-grid-fill text-primary me-2"></i>Danh mục: {{ $category->catename }}</h3>
    ...
    @else
        <div class="alert alert-warning text-center py-5 rounded-4 shadow-sm">
            ...
            <h5 class="fw-bold">Chưa có sản phẩm nào thuộc danh mục này.</h5>
