    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <h5>Laravel Shop</h5>
                <p>Chuyên cung cấp sản phẩm công nghệ, phụ kiện máy tính và thiết bị điện tử với giá cả hợp lý.</p>
            </div>
            {{-- Cột 2 --}}
            <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="{{ route('products.search') }}" class="text-white text-decoration-none">Sản phẩm</a></li>
            ...
            <div class="col-md-4 mb-4">
                ...
                <p>0909 999 999</p>
                <p>✉ support@laravelshop.com</p>
            </div>
        </div>
        <hr>
        <div class="text-center">
            <small>© 2026 Laravel Shop. All Rights Reserved.</small>
        </div>
    </div>
</footer>
